		...
		<tr>
			...
			@endif
				@if(!empty($receipt_details->invoice_heading))
					<h2 style="font-weight: bold; font-size: 24px !important; margin-top: 10px;">{!! $receipt_details->invoice_heading !!}</h2>
				@endif
			</td>
		</tr>
			@if(!empty($receipt_details->letter_head))
	...
	<div class="col-md-6 invoice-col width-50" >
		...
		<!-- Shop & Location Name  -->
			...
			<span>
				...
				<h2 style="font-weight: bold; font-size: 18px !important; margin-top: 10px;">{{$receipt_details->display_name}}</h2>
...
<div class="row mt-5" >
    ...
    <td style="width: 5%; border: 1px solid black;">#</td>
                    ...
                    @if(!empty($receipt_details->discounted_unit_price_label))
                        ...
                        @endphp
                    @endif
                                        <td style="width: {{$p_width}}%; border: 1px solid black; text-align: center;">
					...
					@if(!empty($line['modifiers']))
						@foreach($line['modifiers'] as $modifier)
							<tr style="border: 1px solid black;">
								...
								@if(!empty($receipt_details->discounted_unit_price_label))
									<td class="text-right" style="border: 1px solid black;">{{$modifier['unit_price_exc_tax']}}</td>
								@endif
								@if(!empty($receipt_details->item_discount_label))
...
{{--
				...
				<!-- Total -->
				<tr>
					<th style="background-color: #357ca5 !important; color: white !important" class="font-15 padding-10">
						{!! $receipt_details->total_label !!}
					</th>
					<td class="text-right font-15 padding-10" style="background-color: #357ca5 !important; color: white !important">
	...
	<!-- Total -->
<tr>
    <th class="font-15 padding-10">
        {!! $receipt_details->total_label !!}
    </th>
    <td class="text-right font-15 padding-10">
        {{$receipt_details->total}}
    </td>
</tr>
