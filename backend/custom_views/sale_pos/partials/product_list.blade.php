@forelse($products as $product)
	<div class="col-md-3 col-xs-4 product_list no-print">
		...
		<div class="text_div">
			...
			@if(\App\System::getProperty('jerry_pos_list_show_sku') != '0')
			<small class="text-muted">
				({{$product->sub_sku}})
			</small><br>
			@endif
			@if(\App\System::getProperty('jerry_pos_list_show_stock') != '0')
			...
			<small class="text-muted" style="white-space: nowrap;">
				@if(\App\System::getProperty('jerry_pos_list_show_pp') == '1')
