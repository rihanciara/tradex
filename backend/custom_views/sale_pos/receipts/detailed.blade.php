<table style="width:100%;">
    ...
    <tbody>
        <tr>
            <td class="text-center" style="line-height: 15px !important; padding-bottom: 10px !important; margin-top: 0 !important;">
 ...
 @if (!empty($receipt_details->invoice_heading))
                    ...
                    <p style="font-weight: bold; font-size: 14px !important; line-height: 1;">{!! $receipt_details->invoice_heading !!}</p>
                @endif
                ...
                <div class="row ">
                    <div class="col-xs-12">
                        ...
                        <table class="table table-bordered table-no-top-cell-border table-slim">
                            <thead>
                                <tr style="background-color: #d03d56 !important; color: white !important; font-size: 15px !important"
                                    class="table-no-side-cell-border table-no-top-cell-border text-center">
                                    <td
                                        style="background-color: #d03d56 !important; color: white !important;width: 3% !important">
                                        #</td>
                                    ...
                                    @endif
                                    <td
                                        style="background-color: #d03d56 !important; color: white !important; width: {{ $p_width }}% !important">
                                        {{ $receipt_details->table_product_label }}
                                    </td>

                                    @if ($receipt_details->show_cat_code == 1)
                                        <td
                                            style="background-color: #d03d56 !important; color: white !important; width: 10% !important;">
                                   ...
                                   <td
                                    ...
                                    <td
                                        style="background-color: #d03d56 !important; color: white !important;width: 8% !important;">
                                    ...
                                    <td
                                        style="background-color: #d03d56 !important; color: white !important;width: 10% !important;">
                                       {{-- {{ $receipt_details->table_unit_price_label }} (@lang('product.inc_of_tax')) --}} Amt(+VAT)
                                    </td>
                                    <td
                                        style="background-color: #d03d56 !important; color: white !important;width: 10% !important;">
                            ...
                            <tbody>
                                @foreach ($receipt_details->lines as $line)
                                    ...
                                    <td class="text-right">
    @if (($line['total_line_discount'] ?? 0) > 0)
                ...
                <div class="row invoice-info " style="page-break-inside: avoid !important">
                    ...
                    <div class="col-md-6 invoice-col width-50">
                               ...
                               <tr>
                                ...
                                @if (empty($receipt_details->hide_price) && !empty($receipt_details->tax_summary_label))
                                    @if (!empty($receipt_details->taxes))
                                        @php
                                            $first_tax = collect($receipt_details->taxes)->slice(0, 1);
                                        @endphp
                                        @foreach ($first_tax as $key => $val)
                                            <tr>
                                                <td class="text-left" style="border: none;"><b>{{ $key }}</b></td>
                                                <td class="text-right" style="border: none;">{{ $val }}</td>
                                            </tr>
                                        @endforeach
                                    @endif
                                @endif
                                ...
                                <!-- Total -->
                                <tr>
                                    <th style="background-color: #d03d56 !important; color: white !important"
                                        class="font-14 padding-10">
                                        {!! $receipt_details->total_label !!}
                                    </th>
                                    <td class="text-right font-14 padding-10"
                                        style="background-color: #d03d56 !important; color: white !important">
                                        {{ $receipt_details->total }}
                                    </td>
                                </tr>
                                @if (!empty($receipt_details->total_in_words))
                                    <tr>
                                        <td colspan="2" class="text-right" style="font-size: 18px; text-transform: uppercase;">
                                           AED {{ $receipt_details->total_in_words }} 
                                        </td>
                                    </tr>
                        ...
                        @if (!empty($receipt_details->total_due) && !empty($receipt_details->total_due_label))
                            <div class="bg-light-blue-active text-right font-14 padding-5">
                                <span class="pull-center bg-light-blue-active">
                        ...
                        @if (!empty($receipt_details->total_paid))
                            <div class="text-right font-14 ">
                                <span class="pull-center">{!! $receipt_details->total_paid_label !!}</span>
