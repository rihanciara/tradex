<style>
    /* General styles for the invoice table */
    .invoice-table {
        width: 100%;
    ...
    .invoice-table th, .invoice-table td {
        border: 1px solid #000; /* Increased border width and set to black for better visibility */
        padding: 8px;
        text-align: left;
    }
    .invoice-table th {
    ...
    /* Specific styles for inner tables within the invoice table */
    .invoice-table .table-slim, .invoice-table .table-slim th, .invoice-table .table-slim td {
        border: 1px solid #000; /* Ensure inner tables also have visible borders */
    }

    /* Additional styles for nested tables within the invoice table */
    .invoice-table .table-no-side-cell-border, .invoice-table .table-no-side-cell-border th, .invoice-table .table-no-side-cell-border td {
        border: 1px solid #000; /* Ensure nested tables also have visible borders */
    }

    /* Ensure all table borders are visible within the invoice table */
    .invoice-table table {
        border: 1px solid #000;
    }

    /* Ensure vertical borders are clearly visible within the invoice table */
    .invoice-table td, .invoice-table th {
        border-left: 1px solid #000;
        border-right: 1px solid #000;
    }

    /* Ensure vertical borders are clearly visible for inner tables within the invoice table */
    .invoice-table .table-slim td, .invoice-table .table-slim th {
        border-left: 1px solid #000;
        border-right: 1px solid #000;
    }

    /* Ensure vertical borders are clearly visible for nested tables within the invoice table */
    .invoice-table .table-no-side-cell-border td, .invoice-table .table-no-side-cell-border th {
        border-left: 1px solid #000;
        border-right: 1px solid #000;
    }

    /* Ensure table headers have black text within the invoice table */
    .invoice-table th {
        color: #000; /* Ensure text color is black */
    }
</style>
        ...
        <tr>
            <td class="text-center" style="line-height: 15px !important; padding-bottom: 10px !important">
                ...
                @if (!empty($receipt_details->invoice_heading))
                    <p style="font-weight: bold; font-size: 25px !important; line-height: 1;">{!! $receipt_details->invoice_heading !!}</p>
                @endif
            </td>
        </tr>
        @if (!empty($receipt_details->letter_head))
            ...
            <td>
                ...
                <div class="row ">
                    <div class="col-xs-12">
                        ...
                        <table class="table table-bordered table-no-top-cell-border table-slim">
                            <thead>
                                <tr style="background-color: #FFDDE1 !important; color: black !important; font-size: 15px !important"
                                    class="table-no-side-cell-border table-no-top-cell-border text-center">
                                    <td
                                        style="background-color: #FFDDE1 !important; color: black !important;width: 3% !important">
                                        #</td>
                                    ...
                                    @endif
                                    <td
                                        style="background-color: #FFDDE1 !important; color: black !important; width: {{ $p_width }}% !important">
                                        {{ $receipt_details->table_product_label }}
                                    </td>

                                    @if ($receipt_details->show_cat_code == 1)
                                        <td
                                            style="background-color: #FFDDE1 !important; color: black !important; width: 10% !important;">
                                    ...
                                    <td
                                        style="background-color: #FFDDE1 !important; color: black !important;width: 8% !important;">
                    ...
                    <div class="col-md-6 invoice-col width-50">
                        <table class="table-no-side-cell-border table-no-top-cell-border width-100 table-slim">
                            <tbody>
                                ...
                                <!-- Total -->
                                <tr>
                                    <th style="background-color: #FFDDE1 !important; color: black !important"
                                        class="font-23 padding-10">
                                        {!! $receipt_details->total_label !!}
                                    </th>
                                    <td class="text-right font-23 padding-10"
                                        style="background-color: #FFDDE1 !important; color: black !important">
                ...
                @if (!empty($receipt_details->total_due) && !empty($receipt_details->total_due_label))
                    <div class="bg-light-blue-active text-right font-23 padding-5">
                        <span class="pull-right bg-light-blue-active">
