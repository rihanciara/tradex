...
<br>
		...
		<small class="text-muted" style="white-space: nowrap;">
			@if(\App\System::getProperty('jerry_pos_cart_show_pp') == '1')
				PP: @if(!empty($product->dpp_inc_tax)) {{ number_format($product->dpp_inc_tax, 2)}} @else 0 @endif
			@endif
		</small>
	...
	<td>
		...
		<div class="input-group input-number">
			@if(\App\System::getProperty('jerry_pos_hide_qty_buttons') != '1')
		...
		@if(count($sub_units) > 0)
			@if(\App\System::getProperty('jerry_pos_hide_unit_dropdown') != '1') <br> @endif
			<select name="products[{{$row_count}}][sub_unit_id]" class="form-control input-sm sub_unit @if(\App\System::getProperty('jerry_pos_hide_unit_dropdown') == '1') hide @endif" @if(\App\System::getProperty('jerry_pos_hide_unit_dropdown') == '1') style="display: none;" @endif>
                @foreach($sub_units as $key => $value)
		...
		@else
			@if(\App\System::getProperty('jerry_pos_hide_unit_dropdown') != '1')
				{{$product->unit}}
			@endif
		@endif
