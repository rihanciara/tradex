    ...
    <div class="tw-px-5 tw-py-3">
        <div class="tw-flex tw-items-start tw-justify-between tw-gap-6 lg:tw-items-center">
            ...
            <div class="tw-flex tw-flex-wrap tw-items-center tw-justify-end tw-gap-3">
                ...
                <style>
                    #btnLowEndPcUIDetails summary::-webkit-details-marker { display: none; }
                    .low-end-accordion summary::-webkit-details-marker { display: none; }
                </style>
                <details id="btnLowEndPcUIDetails" class="tw-dw-dropdown tw-relative tw-inline-block tw-text-left tw-mr-2">
                    <summary id="btnLowEndPcUI" title="Performance Optimization"
                        class="tw-hidden md:tw-inline-flex tw-items-center tw-justify-center tw-text-sm tw-font-medium tw-text-white tw-transition-all tw-duration-200 tw-bg-@if(!empty(session('business.theme_color'))){{session('business.theme_color')}}@else{{'primary'}}@endif-800 hover:tw-bg-@if(!empty(session('business.theme_color'))){{session('business.theme_color')}}@else{{'primary'}}@endif-700 tw-p-1.5 tw-rounded-lg tw-ring-1 hover:tw-text-white tw-ring-white/10 tw-cursor-pointer tw-list-none" style="list-style: none;">
                        <span class="tw-sr-only" aria-hidden="true">Low-End PC Mode</span>
                        <svg aria-hidden="true" class="tw-size-5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5">
                            <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
                            <path d="M13 3l0 7l6 0l-8 11l0 -7l-6 0l8 -11" />
                        </svg>
                    </summary>

                    <div class="tw-dw-menu tw-dw-dropdown-content tw-p-4 tw-w-80 tw-absolute tw-right-0 tw-z-50 tw-mt-2 tw-origin-top-right tw-bg-white tw-rounded-lg tw-shadow-2xl tw-ring-1 tw-ring-gray-200 focus:tw-outline-none" tabindex="-1">
                        <div class="tw-flex tw-items-center tw-justify-between tw-mb-4">
                            <h3 class="tw-text-base tw-font-bold tw-text-gray-900">Low-End PC Mode</h3>
                            <label class="tw-relative tw-inline-flex tw-items-center tw-cursor-pointer">
                                <input type="checkbox" id="toggleLowEndPc" class="tw-sr-only tw-peer">
                                <div class="tw-w-11 tw-h-6 tw-bg-gray-200 tw-peer-focus:tw-outline-none tw-peer-focus:tw-ring-2 tw-peer-focus:tw-ring-primary-300 tw-rounded-full tw-peer tw-peer-checked:tw-after:translate-x-full tw-peer-checked:tw-after:border-white tw-after:content-[''] tw-after:absolute tw-after:top-[2px] tw-after:left-[2px] tw-after:bg-white tw-after:border-gray-300 tw-after:border tw-after:rounded-full tw-after:h-5 tw-after:w-5 tw-after:transition-all tw-peer-checked:tw-bg-green-500"></div>
                            </label>
                        </div>
                        
                        <p class="tw-text-xs tw-text-gray-500 tw-mb-4 tw-whitespace-normal">Boost responsiveness on older hardware by stripping away heavy visuals.</p>

                        <div class="tw-space-y-2">
                            <details class="tw-group tw-border tw-border-gray-200 tw-rounded-lg low-end-accordion">
                                <summary class="tw-flex tw-items-center tw-justify-between tw-p-2 tw-font-medium tw-cursor-pointer tw-text-gray-700 hover:tw-bg-gray-50 tw-transition-colors tw-list-none" style="list-style: none;">
                                    <span class="tw-text-xs tw-font-bold">Disable Box Shadows</span>
                                    <span class="tw-transition tw-duration-300 group-open:tw-rotate-180">
                                ...
                                <div class="tw-p-2 tw-text-[11px] tw-text-gray-600 tw-border-t tw-border-gray-200 tw-bg-gray-50 tw-whitespace-normal">
                                    <strong class="tw-text-gray-800">Pros:</strong> Massively reduces GPU rendering. Modal and card edges will appear flat but load instantly without dragging down scroll performance.
                                </div>
                            </details>

                            <details class="tw-group tw-border tw-border-gray-200 tw-rounded-lg low-end-accordion">
                                <summary class="tw-flex tw-items-center tw-justify-between tw-p-2 tw-font-medium tw-cursor-pointer tw-text-gray-700 hover:tw-bg-gray-50 tw-transition-colors tw-list-none" style="list-style: none;">
                                    <span class="tw-text-xs tw-font-bold">Disable CSS Animations</span>
                                    <span class="tw-transition tw-duration-300 group-open:tw-rotate-180">
                                        <svg fill="none" height="16" shape-rendering="geometricPrecision" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" viewBox="0 0 24 24" width="16"><path d="M6 9l6 6 6-6"></path></svg>
                                    </span>
                                </summary>
                                <div class="tw-p-2 tw-text-[11px] tw-text-gray-600 tw-border-t tw-border-gray-200 tw-bg-gray-50 tw-whitespace-normal">
                                    <strong class="tw-text-gray-800">Pros:</strong> Stops all CSS-based transitions. Elements snap immediately to their states, saving CPU cycles and preventing micro-stutters.
                                </div>
                            </details>

                            <details class="tw-group tw-border tw-border-gray-200 tw-rounded-lg low-end-accordion">
                                <summary class="tw-flex tw-items-center tw-justify-between tw-p-2 tw-font-medium tw-cursor-pointer tw-text-gray-700 hover:tw-bg-gray-50 tw-transition-colors tw-list-none" style="list-style: none;">
                                    <span class="tw-text-xs tw-font-bold">Disable jQuery Effects</span>
                                    <span class="tw-transition tw-duration-300 group-open:tw-rotate-180">
                                        <svg fill="none" height="16" shape-rendering="geometricPrecision" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" viewBox="0 0 24 24" width="16"><path d="M6 9l6 6 6-6"></path></svg>
                                    </span>
                                </summary>
                                <div class="tw-p-2 tw-text-[11px] tw-text-gray-600 tw-border-t tw-border-gray-200 tw-bg-gray-50 tw-whitespace-normal">
                                    <strong class="tw-text-gray-800">Pros:</strong> Forces Dropdowns, Modals, and the Sidebar to snap open/closed instantly instead of sliding or fading, speeding up UI interactions.
                                </div>
                            </details>
                        </div>
                    </div>
