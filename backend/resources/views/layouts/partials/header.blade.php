        ...
        <div class="tw-flex tw-items-start tw-justify-between tw-gap-6 lg:tw-items-center">
            ...
            <div class="tw-flex tw-flex-wrap tw-items-center tw-justify-end tw-gap-3">
                ...
                <details class="tw-dw-dropdown tw-relative tw-inline-block tw-text-left">
                    ...
                    <ul class="tw-dw-menu tw-dw-dropdown-content tw-dw-z-[1] tw-dw-bg-base-100 tw-dw-rounded-box tw-w-48 tw-absolute tw-left-0 tw-z-[1050] tw-mt-2 tw-origin-top-right tw-bg-white tw-rounded-lg tw-shadow-lg tw-ring-1 tw-ring-gray-200 focus:tw-outline-none"
                ...
                <details class="tw-dw-dropdown tw-relative tw-inline-block tw-text-left">
                    ...
                    <ul class="tw-p-2 tw-w-48 tw-absolute tw-right-0 tw-z-[1050] tw-mt-2 tw-origin-top-right tw-bg-white tw-rounded-lg tw-shadow-lg tw-ring-1 tw-ring-gray-200 focus:tw-outline-none"
                        role="menu" tabindex="-1">
